...
<html>
    <head>
        <title>Sign up | Dragenger</title>
        <link rel="stylesheet"type="text/css"href="styles/dstyle.css">
    </head>

    <body class="bodycss">
        <h3 class="headercss"style="padding-top:30px;font-size: 30px;">Sign up | Dragenger</h3>
		<div>
			<img src="res\icon.png" class="logo-animator">
		</div>
        <form action="" method="post">
			<?php echo '<span class="headercss">'.$success_message.'<br><br></span>';?>
        ...
        Or, Go to <a href="login.php"class="buttoncss">Log In</a>
		<br><br>
    </body>
</html>